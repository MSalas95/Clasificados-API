...
class Api::V1::UsersControllerTest < ActionController::TestCase
  ...
  test "should create api_v1_user" do
    assert_difference('Api::V1::User.count') do
      post :create, api_v1_user: { password: @api_v1_user.password, user_email: @api_v1_user.user_email, user_name: @api_v1_user.user_name }
    end
  ...
  test "should update api_v1_user" do
    put :update, id: @api_v1_user, api_v1_user: { password: @api_v1_user.password, user_email: @api_v1_user.user_email, user_name: @api_v1_user.user_name }
    assert_response 204
  end
